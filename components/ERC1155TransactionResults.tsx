...
interface ERC1155TransactionResult {
  queueId: string;
...
interface ERC1155TransactionResultsProps {
  results: ERC1155TransactionResult[];
}

export function ERC1155TransactionResults({ results }: ERC1155TransactionResultsProps) {
