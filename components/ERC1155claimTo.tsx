...
export default function ERC1155ClaimTo() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/claimERC1155", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
        body: JSON.stringify({ receiver: toAddress, tokenId: tokenId, quantity: amount }),
      });
